...
# --
    ...
    def __new__(cls, **kwarg: Any):
        ...
        if not hasattr(cls, 'instance') or not cls.instance:
            ...
            cls.instance.log_config_dictionary = cls.get_log_config_dictionary()
            ...
            cls.instance.log_config_dictionary = cls.instance.log_config_dictionary[kwarg['config']]
...
# --
    ...
    @classmethod
    def get_log_config_dictionary(cls) -> str:
        return ''
